...
E void NDECL(bot);
//E void FDECL(hpbar, (struct monst *,int)); /*test*/
...
E void FDECL(set_delayed_killer, (int, int, const char *));
E char *FDECL(get_delayed_killer, (int, int *));
E void FDECL(remove_delayed_killer, (int));
...
E int FDECL(start_ring_levitation, (struct obj *));
E int FDECL(stop_ring_levitation, (struct obj *));
E int NDECL(can_transit_levitation);
E boolean NDECL(can_levitate);
E int NDECL(start_levitation);
E int NDECL(stop_levitation);
E int FDECL(levitation_on, (long, BOOLEAN_P));
E int FDECL(levitation_off, (struct obj *));
E int FDECL(invoke_levitation, (struct obj *));
...
E void FDECL(mstealm, (struct monst *, struct monst *, struct obj *, BOOLEAN_P));
...
E int NDECL(lminion);
E void FDECL(setmaligntyp, (struct monst *,SCHAR_P));
E aligntyp FDECL(getmaligntyp, (struct monst *));
...
E struct obj *FDECL(mk_ranked_obj_at, (CHAR_P,int,int,int,BOOLEAN_P));
...
E void FDECL(reset_color, (struct obj *));
...
E char *FDECL(named_obj_name, (struct obj *));
...
E void FDECL(scales_to_dsm, (struct obj *));
...
E char *FDECL(price_str, (struct obj *, struct monst *));
...
E char *FDECL(Shk_Your, (char *,struct obj *));
E void FDECL(shk_record_pickedobj, (struct monst *, struct obj *));
...
E void FDECL(know_enchantment_worker, (struct obj *, winid));
...
E int FDECL(water_damage, (struct obj *,BOOLEAN_P,BOOLEAN_P));
...
E void FDECL(add_xdat_obj, (struct obj   *, uchar, genericptr_t));
E void FDECL(add_xdat_mon, (struct monst *, uchar, genericptr_t));
E genericptr_t FDECL(get_xdat_obj, (struct obj   *, uchar));
E genericptr_t FDECL(get_xdat_mon, (struct monst *, uchar));
E void FDECL(del_xdat_obj, (struct obj   *, uchar));
E void FDECL(del_xdat_mon, (struct monst *, uchar));
E void FDECL(copy_xdat_obj, (struct obj *, struct obj *));
E boolean FDECL(compare_xdat_obj, (struct obj *, struct obj *));
E int FDECL(namelth_xdat_obj, (struct obj *));
E void FDECL(savexdatchn, (int, struct xdat *, int));
E struct xdat *FDECL(restxdatchn, (int, BOOLEAN_P));
E void FDECL(refresh_xdat_obj, (struct obj *));
E void FDECL(refresh_xdat_mon, (struct monst *));

#ifdef WIZARD
E int NDECL(wiz_xdat);
#endif /* WIZARD */
...
E int NDECL(dozap);
E int FDECL(zhitm, (struct monst *,struct zapinfo *,struct obj **));
E void FDECL(zhitu, (struct zapinfo *,const char *,XCHAR_P,XCHAR_P));
