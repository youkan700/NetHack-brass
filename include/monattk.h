...
#define AD_ELEC		5	/* shock damage */
#define AD_DRST		6	/* drains str (poison) */
#define AD_ACID		7	/* acid damage */
#define AD_DISN		8	/* disintegration */
#define AD_PLYS		9	/* paralysys */
#define AD_DETH		10	/* for Death, or death ray */
...
#define AD_DRWN		42	/* drowning attack (water elemental) */
