...
#define BHIT_GLYPH_FIREBALL	6   /* (16 - NUM_ZAP) */
...
#define THROWN_SPELL	(BHIT_GLYPH_FIREBALL|BHIT_SENSEINVIS)
...
#define NOREPLMON	0x08	/* monst pointer should not be moved */
