...
#define MR_ELEC		0x08	/* resists electricity */
#define MR_POISON	0x10	/* resists poison */
#define MR_ACID		0x20	/* resists acid */
#define MR_DISINT	0x40	/* resists disintegration */
