...
#endif /*JP*/
#define MAX_DKILLER	 5
E NEARDATA int killer_format;
E const char *killer;
E const char *delayed_killer;
E struct dkiller_info {
	int killer_format;
	int killer;
	char delayed_killer[BUFSZ];
} delayed_killers[MAX_DKILLER];
...
#define	GOODPOS_CANSEE		0x0001
#define GOODPOS_COULDSEE	0x0002
#define	GOODPOS_NOWALL		0x0004
#define	GOODPOS_EXACTDIST	0x0008
