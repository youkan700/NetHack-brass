...
{	{E_J("Archeologist",	"çlå√äwé“"	), 0}, {
	...
	"à‚ê’ÇÃíTåüÇ‚î≠å@í≤ç∏Ç…í∑ÇØÇΩêEã∆Ç≈Ç∑ÅB\0"
	"êÌì¨ÇÕÇ†Ç‹ÇËìæà”Ç≈ÇÕÇ†ÇËÇ‹ÇπÇÒÇ™ÅAê√Ç©Ç…ëfëÅÇ≠çsìÆÇ≈Ç´ÅA\0"
	"édéñÇ…ïKóvÇ»ï÷óòÇ»ìπãÔÇÇ¢Ç≠Ç¬Ç©éùÇøçûÇÒÇ≈èoî≠ÇµÇ‹Ç∑ÅB\0"
	"„©ÇÃî≠å©ÅAïÛêŒÇÃä”íËÇ™ìæà”Ç≈Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Barbarian",	"ñÏîÿêl"	), 0}, {
	...
	"Ç†ÇÁÇ‰ÇÈïêäÌÇ∆ñhãÔÇÃàµÇ¢Ç…í∑ÇØÇΩÅAãﬂê⁄êÌì¨ÇÃêÍñÂâ∆Ç≈Ç∑ÅB\0"
	"óßÇøÇ”Ç≥Ç™ÇÈëäéËÇÇ∑Ç◊Çƒí@Ç´í◊Ç∑óÕÇéùÇøÇ‹Ç∑Ç™ÅA\0"
	"ñÇñ@ÇÕçDÇ›Ç‹ÇπÇÒÅBÇ‹ÇΩÅAì≈Ç÷ÇÃëœê´ÇêgÇ…Ç¬ÇØÇƒÇ¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Caveman",		"ì¥åAêl"	), E_J("Cavewoman",0)}, {
	...
	"ì¥åAÇ…èZÇ›ÅAëfñpÇ»ïÈÇÁÇµÇÇµÇƒÇ¢ÇÈàÍë∞Ç≈Ç∑ÅB\0"
	"óÕÇ™ã≠Ç≠ÅAå¥énìIÇ»ïêãÔÇégÇ¡ÇΩêÌì¨Ç™ìæà”Ç≈Ç∑ÅB\0"
	"ñÇñ@ÇÕÇ‚Ç‚ãÍéËÇ≈Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Healer",		"ñ¸ÇµéË"	), 0}, {
	...
	"ïaãCÇ‚âˆâ‰Çñ¸Ç∑ãZèpÇèKìæÇµÇƒÇ¢ÇÈêEã∆Ç≈Ç∑ÅB\0"
	"êÌì¨ÇÕÇ†Ç‹ÇËìæà”Ç≈ÇÕÇ†ÇËÇ‹ÇπÇÒÇ™ÅAê∂Ç´âÑÇ—ÇÈÇÃÇ…ïKóvÇ»\0"
	"íméØÇéùÇøÅAÇ≥Ç‹Ç¥Ç‹Ç»à„ó√ìπãÔÇ∆ñÚÇågÇ¶ÇƒÇ¢Ç‹Ç∑ÅB\0"
	"êEã∆ïøÅAÇÕÇ∂ÇﬂÇ©ÇÁì≈Ç÷ÇÃëœê´ÇêgÇ…Ç¬ÇØÇƒÇ¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Knight",		"ãRém"		), 0}, {
	...
	"ì∆ì¡Ç»ãRémìπê∏ê_ÇèdÇÒÇ∂ÇÈêÌémÇ≈Ç∑ÅBïêäÌÇÃàµÇ¢Ç…í∑ÇØÅA\0"
	"èdëïîıÇ≈ÇÃêÌì¨Ç™ìæà”Ç≈Ç∑ÅBãRèÊÇµÇƒÇÃêÌì¨Ç‡ìæà”Ç≈ÅA\0"
	"înè„ëÑÇç\Ç¶ÇƒÇÃìÀåÇÇÕçÇÇ¢à–óÕÇå÷ÇËÇ‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Monk",		"èCçsëm"	), 0}, {
	...
	"ì∆é©ÇÃâ˙ó•ÇéÁÇËÅAé©ëRÇÃíÜÇ≈èCçsÇÇµÇƒÇ¢ÇÈèCìπémÇ≈Ç∑ÅB\0"
	"ìkéËãÛåùÇ≈ÇÃêÌÇ¢Çç≈Ç‡ìæà”Ç∆ÇµÇ‹Ç∑ÅBèdÇ¢äZÇÕãÍéËÇ≈Ç∑Ç™ÅA\0"
	"åyëïÇ≈Ç†Ç¡ÇƒÇ‡èdêÌémÇ…à¯ÇØÇéÊÇÁÇ»Ç¢êÌì¨óÕÇî≠äˆÇµÇ‹Ç∑ÅB\0"
	"â˙ó•Ç…ÇÊÇËÅAì˜êHÇîÇØÇƒÇ¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Medium",		"õﬁèó"		), 0}, {
	{E_J("Pure Girl",	"ñ≥çCÇ»è≠èó"	), 0},
	{E_J("Jinme Girl",	"å‰ê_înÇÃè≠èó"	), 0},
	{E_J("Mist Maiden",	"í©ñ∂ÇÃõﬁèó"	), 0},
	{E_J("Moon Maiden",	"ó[åéÇÃõﬁèó"	), 0},
	{E_J("Princess Maiden",	"ïPõﬁèó"	), 0},
	{E_J("Hanuman Maiden",	"éRê_ÇÃõﬁèó"	), 0},
	{E_J("Ryujin Maiden",	"ó¥ê_ÇÃõﬁèó"	), 0},
	{E_J("Kamiko",		"ê_éq"		), 0},
	{E_J("Eternal Maiden",	"èÌâ≥èó"	), 0} },
#ifndef JP
	...
	"Med", "å√Ç´ê_é–", "ódåœÇÃì¥åA",
	"ê_é–Ç…édÇ¶ÇÈê_êEÇÃèóê´Ç≈Ç∑ÅBóÕÇÕé„Ç¢Ç≈Ç∑Ç™ÅAã|Ç™ìæà”Ç≈Ç∑ÅB\0"
	"ê¥ÇﬂÇÃóÕÇéùÇøÅAñÓÇ…îjñÇÇÃóÕÇÇ±ÇﬂÇƒï˙Ç¬Ç±Ç∆Ç™Ç≈Ç´Ç‹Ç∑ÅB\0"
	"Ç®éDÅiä™ï®ÅjÇìäÇ∞ÇƒóÕÇà¯Ç´èoÇ∑ì¡éÍî\óÕÇéùÇ¡ÇƒÇ¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Priest",		"ëmóµ"		), E_J("Priestess","ìÚëm")}, {
	...
	"éõâ@Ç…édÇ¶ÇÈëmóµêÌémÇ≈Ç∑ÅB\0"
	"èÉêàÇ»êÌémÇ…ÇÕãyÇŒÇ»Ç¢Ç‡ÇÃÇÃÅAèdëïîıÇ≈ÇÃêÌì¨ÇÇ±Ç»ÇµÅA\0"
	"ì›äÌÇàµÇ§ÇÃÇ™ìæà”Ç≈ÅAñÇñ@Ç‡égÇ¶Ç‹Ç∑ÅB\0"
	"ïiï®ÇÃèjïüÅEéÙÇ¢ÇÃèÛë‘ÇàÍñ⁄Ç≈å©ï™ÇØÇÈÇ±Ç∆Ç™Ç≈Ç´Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Rogue",		"ìêëØ"), 0}, {
	...
	"ìêÇ›Çê∂ã∆Ç∆ÇµÇƒÇ¢ÇÈÇ≤ÇÎÇ¬Ç´Ç≈Ç∑ÅB\0"
	"ëfëÅÇ≠ÅAéËêÊÇ™äÌópÇ≈ÅAåÆÇ‚„©ÇäOÇµÇΩÇËÅA\0"
	"ëäéËÇ©ÇÁèäéùïiÇìêÇ›éÊÇÈÇÃÇ™ìæà”Ç≈Ç∑ÅB\0"
	"è¨å^ÇÃênï®ÇégÇ¢Ç±Ç»ÇµÅAì¡éÍÇ»à√éEèpÇèKìæÇµÇ‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Ranger","ÉåÉìÉWÉÉÅ["), 0}, {
	...
	"éRñÏÇ≈ÇÃäàìÆÇ…í∑ÇØÇΩêEã∆Ç≈ÅAÇ´ÇÌÇﬂÇƒã≠óÕÇ»éÀéËÇ≈Ç∑ÅB\0"
	"ã|ÇÃàµÇ¢Ç™Ç∆ÇƒÇ‡è„éËÇ≠ÅAâìãóó£Ç©ÇÁìGÇì|ÇµÇ‹Ç∑ÅB\0"
	"ìGÇ…ãCÇ√Ç©ÇÍÇ∏Ç…ëfëÅÇ≠çsìÆÇ∑ÇÈÇ∑Ç◊ÇêgÇ…Ç¬ÇØÇƒÇ¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
/*	{"Ninja","Kunoichi"},*/  /* secret society */
	...
	"ìåï˚ÇÃï”ã´Ç©ÇÁóàÇΩÅAïóïœÇÌÇËÇ»êÌémÇ≈Ç∑ÅB\0"
	"àŸçëÇÃã≠óÕÇ»ïêãÔÇëïîıÇµÇƒÇ®ÇËÅAã∞ÇÈÇ◊Ç´êÌì¨óÕÇ≈\0"
	"óßÇøÇÕÇæÇ©ÇÈé“Ç∑Ç◊ÇƒÇéaÇËï•Ç¢Ç‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Tourist",		"äœåıãq"	), 0}, {
	...
	"â^ñΩÇÃëÂñ¿ã{Ç…äœåıÇ…óàÇΩó∑çsé“Ç≈Ç∑ÅB\0"
	"ínê}Ç∆ÉJÉÅÉâÇéËÇ…ÅAÇ®ìyéYÇîÉÇ§ÇΩÇﬂÇÃÇ®ã‡Ç∆ÅA\0"
	"ÇΩÇ≠Ç≥ÇÒÇÃêHÇ◊ï®ÇÉJÉoÉìÇ…ãlÇﬂÅAñ¿ã{Çå©ï®ÇµÇ‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Valkyrie",	"ÉèÉãÉLÉÖÅ[Éå"	), 0}, {
	...
	"ñkï˚Ç©ÇÁÇ‚Ç¡ÇƒÇ´ÇΩèóê´êÌémÇ≈Ç∑ÅB\0"
	"óÕÇ™ã≠Ç≠ÅAãﬂê⁄êÌì¨Çìæà”Ç∆ÇµÇ‹Ç∑ÅBñÇñ@ÇÕãÍéËÇ≈Ç∑ÅB\0"
	"èÇÇÃàµÇ¢Ç…ì¡Ç…èGÇ≈ÇƒÇ®ÇËÅAìGÇÃçUåÇÇäÒÇπïtÇØÇ‹ÇπÇÒÅB\0"
#endif /*JP*/
	,/*EOS*/
...
{	{E_J("Wizard",		"ñÇñ@égÇ¢"	), 0}, {
	...
	"ñÇñ@ÇÃÉGÉLÉXÉpÅ[ÉgÇ≈Ç∑ÅB\0"
	"óÕÇÕé„Ç≠ÅAïêäÌÇégÇ¡ÇΩêÌì¨ÇÕÇ†Ç‹ÇËìæà”Ç≈ÇÕÇ†ÇËÇ‹ÇπÇÒÇ™ÅA\0"
	"çÇÇ¢ímê´Ç≈Ç†ÇÁÇ‰ÇÈñÇñ@ÇégÇ¢Ç±Ç»ÇµÇ‹Ç∑ÅB\0"
#endif /*JP*/
	,/*EOS*/
