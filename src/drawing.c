...
/*60*/	{'"', EJ2("web",		"蜘蛛の巣"),	   C(CLR_GRAY)},	/* web */
	...
	{'|', EJ2("",			""),		   C(CLR_GRAY)},	/* vbeam */
	{'-', EJ2("",			""),		   C(CLR_GRAY)},	/* hbeam */
	{'\\',EJ2("",			""),		   C(CLR_GRAY)},	/* lslant */
	{'/', EJ2("",			""),		   C(CLR_GRAY)},	/* rslant */
	{'|', EJ2("",			""),		   C(CLR_GRAY)},	/* vbeaml */
	{'|', EJ2("",			""),		   C(CLR_GRAY)},	/* vbeamr */
	{'~', EJ2("",			""),		   C(CLR_GRAY)},	/* hbeamu */
	{'_', EJ2("",			""),		   C(CLR_GRAY)},	/* hbeamd */
	{'*', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_tl */
	{'V', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_tc */
	{'*', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_tr */
	{'>', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_ml */
	{'<', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_mr */
	{'*', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_bl */
	{'^', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_bc */
	{'*', EJ2("",			""),		   C(CLR_GRAY)},	/* rbeam_br */
