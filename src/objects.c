...
ARMOR("ring mail", (char *)0,
	1, 0, 0, 0,	70, 5, 200,  30,  6/*7*/, 0, ARM_SUIT, IRON, 0, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	20, 5, 200,  25,  7/*8*/, 1, ARM_SUIT, IRON, 0, CLR_BLACK),
ARMOR("leather armor", (char *)0,
	1, 0, 0, 0,	60, 3, 100,   5,  7/*8*/, 0, ARM_SUIT, LEATHER, 0, HI_LEATHER),
...
SHIELD("small shield", (char *)0,
		1, 0, 0, 0,	     7, 0, 30,	3,  9, 1, WOOD, 0, HI_WOOD),
...
SHIELD("elemental shield", "runed shield",
		0, 1, 0, 0,	     6, 0, 50, 50,  8, 2, METAL, 0, CLR_BLUE),
SHIELD("shield of reflection", "polished silver shield",
		0, 1, 0, REFLECTING, 6, 0, 50, 50,  8, 2, SILVER, 0, HI_SILVER),
...
BOOTS("levitation boots", "snow boots",
		0, 1,  LEVATWILL, 12, 2, 15, 30,  9, 0, LEATHER, 0, HI_LEATHER),
#undef HELM
#undef CLOAK
#undef SHIELD
#undef GLOVES
...
RING("levitation", LEVATWILL, "agate" ,     200, 1, 0, 7, GEMSTONE, CLR_RED),
