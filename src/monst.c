 ...
 */
	...
	LVL(15, 12, -1, 20, 5), (G_GENO|1),
	A(ATTK(AT_BREA, AD_PLYS, 1, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
 ...
 */
	...
	SIZ(WT_HUMAN, 400, 0, MS_PRIEST, MZ_HUMAN),
 ...
 */
    ...
    MON("animated object", S_WORM_TAIL,
	LVL(0, 12, 10, 0, 0), (G_NOGEN|G_NOCORPSE|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 1),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, 0, 0, 0), MR_POISON|MR_SLEEP|MR_STONE, 0,
	M1_FLY|M1_BREATHLESS|M1_NOTAKE|M1_NOEYES|M1_NOHANDS|M1_NOLIMBS|
	  M1_NOHEAD|M1_MINDLESS, M2_NOPOLY|M2_NEUTER, 0, CLR_WHITE),
